...
-- @collection
DROP TABLE IF EXISTS collection."workersIdentityCards";
...
-- @collection
DROP TABLE IF EXISTS collection."organizationsMembers";
...
-- @collection
DROP TABLE IF EXISTS collection."workerOrganizations";
...
-- @collection
DROP TABLE IF EXISTS collection."organizationsPendingRequests";
...
-- @collection
DROP TABLE IF EXISTS collection."workerPendingRequests";
...
-- @collection
DROP TABLE IF EXISTS collection."workerRoles";
...
-- @collection
DROP TABLE IF EXISTS collection."rolesStandardShifts";
...
-- @collection
DROP TABLE IF EXISTS collection."teamsMembers";
...
-- @collection
DROP TABLE IF EXISTS collection."payrollComputedCompensations";
CREATE TABLE IF NOT EXISTS collection."payrollComputedCompensations" (
  "id" bigint generated by default as identity primary key,
